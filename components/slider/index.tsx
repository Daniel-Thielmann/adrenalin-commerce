...
const slides: Slide[] = [
  {
    ...
    title: "Sinta Adrenalina",
    text: "Os melhores equipamentos você encontra aqui",
  },
  {
    src: "/home/best-products-side-image/utv.jpg",
    alt: "Imagem em destaque 2",
    title: "Para todos os esportes",
    text: "Liberte-se esqueça o medo! A velocidade é sua amiga",
  },
  {
    src: "/home/best-products-side-image/original.jpg",
    alt: "Imagem em destaque 3",
    title: "Aproveite os descontos",
    text: "Grandes decontos e frete grátis, use seu cupom",
  },
  {
    src: "/home/best-products-side-image/bs.jpg",
    alt: "Imagem em destaque 4",
    title: "A sua seguranca",
    text: "Site blindado para manter suas informações protegidas",
  },
  {
    src: "/home/best-products-side-image/friends.jpg",
    alt: "Imagem em destaque 5",
    title: "As melhores marcas",
    text: "Temos as melhores marcas do mercado, qualidade padrão",
  },
  {
    src: "/home/best-products-side-image/brandon.jpg",
    alt: "Imagem em destaque 6",
    title: "A adrenalina te espera",
    text: "Viva a sensação de liberdade que só a adrenalina proporciona",
  },
  {
    src: "/home/best-products-side-image/chama.png",
    alt: "Imagem em destaque 7",
    title: "Para sua aventura",
    text: "Viaje pelo mundo e aproveite as melhores paisagens",
  },
];
    ...
    <div className="grid xl:grid-cols-2">
      <div className="max-w-[1000px] h-[700px] w-full m-auto py-16 px-4 relative group">
        <div className="w-full h-full relative overflow-hidden transition-opacity duration-500">
          <div
            className="w-full h-full rounded-xl bg-center bg-cover inset-0 bg-gradient-to-b from-transparent to-black lg:group-hover:opacity-60 transition-opacity
      ...
      <div
        className="flex flex-auto justify-center flex-col"
        style={{ userSelect: "none" }}
      >
        <h1 className="text-white text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl uppercase mb-16">
          Explore a Adrenalina
        </h1>
        <div className={ibm.className}>
          <div className="space-y-12">
            <p className="text-white text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl text-justify">
              Onde a diversão é séria e a adrenalina é o nosso sobrenome! 🔥
            </p>
            <p className="text-white text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl text-justify">
              Desbrave picos de downhill, domine terrenos selvagens no
              motocross, explore o desconhecido com UTVs e quadriciclos, voe
              pelos mares no kite surf e aventure-se no camping. 🏕️
            </p>
            <p className="text-white text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl text-justify">
              Seja um veterano ou um novato destemido, estamos aqui para
              garantir que sua jornada seja pura adrenalina! 🤘
            </p>
          </div>
        </div>
        <Link href="/allproducts">
          <button
            className="bg-[#E3FC02] w-full md:w-10/12 text-black px-6 py-2 rounded-md md:text-lg lg:text-xl xl:text-2xl duration-200
